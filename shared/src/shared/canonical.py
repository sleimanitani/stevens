...
This module is the single source of truth for signature-scope bytes —
both :mod:`shared.security_client` (agent side) and the Security Agent
(server side) import it. If the two ever diverge, signatures break.
"""
